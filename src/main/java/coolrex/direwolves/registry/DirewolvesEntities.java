...
public class DirewolvesEntities {
    ...
    public static final RegistryObject<EntityType<DirewolfEntity>> DIREWOLF = ENTITIES.register("direwolf", () -> EntityType.Builder.of(DirewolfEntity::new, MobCategory.CREATURE).sized(1.1f, 1.4f).build("direwolf"));
}
